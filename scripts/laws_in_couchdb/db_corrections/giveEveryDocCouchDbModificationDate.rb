...
#   end
#
#   UpdateCouchHelper.bulk_write_to_bwb_database(changed)
# end
#
# # rows = Couch::CLOUDANT_CONNECTION.get_rows_for_view('bwb', 'RegelingInfo', 'all')
# index = JSON.parse open('C:\Users\Maarten\wetten-tools\tools-heroku\scripts\laws_in_couchdb\md\index.json').read.force_encoding('utf-8')
#
# different_paths=[]
# rows.each do |row|
#   doc =row['value']
